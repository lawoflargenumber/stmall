...
import lombok.Data;
import stmall.ProductsApplication;
...
public class Inventory {
    ...
    public static InventoryRepository repository() {
        InventoryRepository inventoryRepository = ProductsApplication.applicationContext.getBean(
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void increaseStock(ItemRetrieved itemRetrieved) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(itemRetrieved.get???()).ifPresent(inventory->{
